...
export const SERVICES_LIST =
  "mt-10 flex w-full flex-col items-stretch sm:mt-12 md:mt-14";

export const SERVICES_ITEM =
  "group relative flex w-full cursor-default items-center justify-center py-0.5 sm:py-1";
...
export const SERVICES_ITEM_SECONDARY_MOBILE =
  "mt-1 font-nav text-[10px] font-normal uppercase leading-none tracking-[0.06em] text-neutral-500 sm:hidden";
